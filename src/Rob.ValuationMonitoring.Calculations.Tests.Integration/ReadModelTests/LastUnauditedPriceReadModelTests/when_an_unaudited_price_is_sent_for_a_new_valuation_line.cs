...
namespace Rob.ValuationMonitoring.Calculations.Tests.Integration.ReadModelTests.LastUnauditedPriceReadModelTests
{
    public class when_an_unaudited_price_is_received_for_an_unknown_line : LastUnauditedPriceReadModelTestBase
    {
        ...
        {
            UpdateUnauditedPriceCommand = new UpdateUnauditedPriceCommand(ValuationLineId, $"InitialName-{ValuationLineId}", DateTime.Parse("01-Dec-2017"), "GBP", 12.3499M, DateTime.Now);
        }
        ...
        [Then]
        public void the_read_model_should_have_the_correct_effective_date_time() => LatestUnauditedPriceReadModel.EffectiveDateTime.ShouldBe(UpdateUnauditedPriceCommand.EffectiveDateTime);
